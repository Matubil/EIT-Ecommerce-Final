// Clase 66 min 30 Aca se va a definir las rutas de nuestras vistas 
...
//Ver Clase 66 min 33 explica como define las cosas
router.get('/',(req, res) => res.render('index', {name: 'John Doe', title: 'Index template EJS'})) //Clase 66 min 37 el metodo render dice que archivo quiero cargar
router.get('/contact',(req, res) => res.render('contact')) //Clase 66 min 45 el metodo render dice que archivo quiero cargar
